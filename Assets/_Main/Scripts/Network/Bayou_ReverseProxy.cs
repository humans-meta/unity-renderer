...
namespace FishNet.Transporting.Bayou
{
    ...
    public class Bayou_ReverseProxy : Transport
    {
        ...
        [SerializeField]
        private string _clientAddress = "eu-west.ssl.cloud.playflow.app";
        /// <summary>
        /// Port to use.
        /// </summary>
        [Tooltip("Port to use.")]
        [SerializeField]
        private ushort _clientPort = 46422;
        #endregion
        ...
        private bool StartClient(string address)
        {
            ...
            return _client.StartConnection(address, _clientPort, _useWss);
        }
